...
<form method="POST"  class="form" enctype="multipart/form-data">
            <table>
                <tr>
                    <td>
                        Name
                        <input type="text" class="login-input" name="text" value="<?php echo $f['name']?>">
                    </td>
                </tr>
                <tr>
                    <td>
                        Username
                        <input type="text" class="login-input" name="user" value="<?php echo $f['username']?>">
                    </td>
                </tr>
                <tr>
                    <td>
                        password
                        <input type="password" class="login-input" name="pass" value="<?php echo $f['password']?>">
                    </td>
                </tr>
                <tr>
                    <td>
...
?>
                ...
                <tr>
                    <td>
                        <input type="submit"  class="login-button" value="submit" name="sub">
